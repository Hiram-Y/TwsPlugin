...
public class RenderableThree extends Renderable {
	...
	private void createPath() {
		...
		pathRight.cubicTo(x + bitmap.getWidth(), y + bitmap.getHeight(), x + bitmap.getWidth(), y + bitmap.getWidth()
				* 0.3f * offsetInPercent, x + bitmap.getWidth() + bitmap.getWidth() / 2 * offsetInPercent,
				y + bitmap.getWidth() * 0.8f * offsetInPercent);
		matchVertsToPath();
	}
