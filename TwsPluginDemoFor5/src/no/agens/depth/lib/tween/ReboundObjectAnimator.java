...
public class ReboundObjectAnimator extends ValueAnimator {
  ...
  public static ReboundObjectAnimator ofFloat(Object target, String propertyName, float from,
      float to) {
  ...
  public static ReboundObjectAnimator ofFloat(Object target, Property propertyName, float from,
      float to) {
    ReboundObjectAnimator animator = new ReboundObjectAnimator(target, propertyName, from, to);
  ...
  public void start() {
    ...
    spring.addListener(new SimpleSpringListener() {
      ...
      @Override public void onSpringUpdate(Spring spring) {
        ...
        } else if (property != null) property.set((View) target, currentAnimatedValue);
