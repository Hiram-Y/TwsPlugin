...
public class CustomShadow extends Drawable {
  ...
  * */
  ...
  private void drawShadow(Canvas canvas) {
    ...
    canvas.drawRect(0, edgeShadowTop, mCardBounds.width() - 2 * insetHorizontal,
  ...
  private void buildShadowCorners() {
    ...
    mEdgeShadowPaint.setShader(
        new LinearGradient(0, -mCornerRadius + mShadowSize, 0, -mCornerRadius - mShadowSize,
            new int[] { mShadowStartColor, mShadowStartColor, mShadowEndColor },
  ...
  float getMinWidth() {
    final float content =
        2 * Math.max(mRawMaxShadowSize, mCornerRadius + mInsetShadow + mRawMaxShadowSize / 2);
