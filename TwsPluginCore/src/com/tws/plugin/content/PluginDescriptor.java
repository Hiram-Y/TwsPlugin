...
public class PluginDescriptor implements Serializable {
	protected static final String TAG = "PluginDescriptor";
	...
	private static ArrayList<String> findClassNameByIntent(Intent intent,
			HashMap<String, ArrayList<PluginIntentFilter>> intentFilter) {
