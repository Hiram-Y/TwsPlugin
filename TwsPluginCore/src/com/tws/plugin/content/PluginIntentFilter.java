...
public class PluginIntentFilter implements Serializable {
	protected static final String TAG = "PluginIntentFilter";
    ...
    public static class MalformedMimeTypeException extends AndroidException {
    	protected static final String TAG = "MalformedMimeTypeException";
...
//                }
            	...
            	TwsLog.d(TAG, "Not a IntentFilter tag : "+ tagName);
            }
    }
