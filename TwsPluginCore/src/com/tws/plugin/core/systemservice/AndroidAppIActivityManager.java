...
public class AndroidAppIActivityManager extends MethodProxy {
	...
	public static void installProxy() {
		...
		Object androidAppActivityManagerProxy = RefInvoker.invokeMethod("android.app.ActivityManagerNative",
		...
		if (singleton.getClass().isAssignableFrom(androidAppIActivityManagerStubProxyProxy.getClass())) {
			RefInvoker.setField("android.app.ActivityManagerNative", "gDefault",
					androidAppIActivityManagerStubProxyProxy);
		} else {// 否则是包装过的单例
			RefInvoker.setField(singleton, "android.util.Singleton", "mInstance",
					androidAppIActivityManagerStubProxyProxy);
		}
		TwsLog.d(TAG, "安装完成");
	}
