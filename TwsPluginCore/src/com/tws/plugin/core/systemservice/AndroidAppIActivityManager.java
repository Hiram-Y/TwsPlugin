...
public class AndroidAppIActivityManager extends MethodProxy {
	...
	public static void installProxy() {
		...
		Object androidAppActivityManagerProxy = RefInvoker.invokeStaticMethod("android.app.ActivityManagerNative",
				"getDefault", (Class[]) null, (Object[]) null);
		...
		if (singleton.getClass().isAssignableFrom(androidAppIActivityManagerStubProxyProxy.getClass())) {
			RefInvoker.setStaticObject("android.app.ActivityManagerNative", "gDefault",
					androidAppIActivityManagerStubProxyProxy);
		} else {// 否则是包装过的单例
			RefInvoker.setFieldObject(singleton, "android.util.Singleton", "mInstance",
					androidAppIActivityManagerStubProxyProxy);
		}
		TwsLog.d(TAG, "安装完成");
	}
	...
	public static class getRunningAppProcesses extends MethodDelegate {
		...
		public Object afterInvoke(Object target, Method method, Object[] args, Object beforeInvoke, Object invokeResult) {
			...
			TwsLog.w(TAG, "getRunningAppProcesses afterInvoke method:" + method.getName());
	...
	public static class getIntentSender extends MethodDelegate {
		...
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.w(TAG, "getIntentSender beforeInvoke method=" + method.getName() + " args[1]=" + args[1]);
