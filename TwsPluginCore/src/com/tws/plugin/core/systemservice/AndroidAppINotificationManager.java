...
public class AndroidAppINotificationManager extends MethodProxy {
	...
	public static class enqueueNotification extends MethodDelegate {
		...
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.w(TAG, "enqueueNotification beforeInvoke method:" + method.getName());
	...
	public static class enqueueNotificationWithTag extends MethodDelegate {
		@Override
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.w(TAG, "enqueueNotificationWithTag beforeInvoke method:" + method.getName());
			args[0] = PluginLoader.getApplication().getPackageName();
			for (Object obj : args) {
				if (obj instanceof Notification) {
					resolveRemoteViews((Notification) obj);
	...
	public static class enqueueNotificationWithTagPriority extends MethodDelegate {
		@Override
		public Object beforeInvoke(Object target, Method method, Object[] args) {
			TwsLog.w(TAG, "enqueueNotificationWithTagPriority beforeInvoke method:" + method.getName());
			args[0] = PluginLoader.getApplication().getPackageName();
			for (Object obj : args) {
				if (obj instanceof Notification) {
					resolveRemoteViews((Notification) obj);
					...
					if (notification.contentIntent != null) {
						...
						if (intent.getAction() != null
							...
							if (pd != null) {
								...
								newInfo.publicSourceDir = getNotificationResourcePath(pd.getInstalledPath(),
