...
public class CompatForSupportv7ViewInflater {
	...
	public static void installPluginCustomViewConstructorCache() {
		Map cache = (Map) RefInvoker.getField(null, "android.support.v7.app.AppCompatViewInflater",
		...
		if (cache != null) {
			...
			RefInvoker.setField(null, "android.support.v7.app.AppCompatViewInflater",
