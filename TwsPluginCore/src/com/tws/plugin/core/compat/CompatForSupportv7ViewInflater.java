...
public class CompatForSupportv7ViewInflater {
	...
	public static void installPluginCustomViewConstructorCache() {
		Map cache = (Map) RefInvoker.getFieldObject(null, "android.support.v7.app.AppCompatViewInflater",
		...
		if (cache != null) {
			...
			RefInvoker.setFieldObject(null, "android.support.v7.app.AppCompatViewInflater",
