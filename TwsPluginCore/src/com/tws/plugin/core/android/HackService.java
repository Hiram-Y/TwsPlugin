...
public class HackService extends HackContextWrapper {
	...
	public void attach(Context mBaseContext, Object mThread, String mClassName, IBinder mToken,
			Application mApplication, Object mActivityManager) {

		RefInvoker.invokeMethod(instance, ClassName, Method_attach,
				new Class[] { Context.class, HackActivityThread.clazz(), String.class, IBinder.class,
						Application.class, Object.class }, new Object[] { mBaseContext, mThread, mClassName, mToken,
