...
public class HackSupportV4LocalboarcastManager {
	...
	public HashMap<BroadcastReceiver, ArrayList<IntentFilter>> getReceivers() {
		return (HashMap<BroadcastReceiver, ArrayList<IntentFilter>>) RefInvoker.getField(instance, ClassName,
				Field_mReceivers);
	}

	public void unregisterReceiver(BroadcastReceiver item) {
		RefInvoker.invokeMethod(instance, ClassName, Method_unregisterReceiver,
				new Class[] { BroadcastReceiver.class }, new Object[] { item });
