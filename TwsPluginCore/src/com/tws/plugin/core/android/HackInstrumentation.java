...
public class HackInstrumentation {
	...
	public void execStartActivitiesAsUser(Context who, IBinder contextThread, IBinder token, Activity target,
		...
		RefInvoker.invokeMethod(instance, android.app.Instrumentation.class.getName(),
				Method_execStartActivitiesAsUser, new Class[] { Context.class, IBinder.class, IBinder.class,
						Activity.class, Intent[].class, Bundle.class, int.class }, new Object[] { who, contextThread,
						token, target, intents, options, userId });
	}
	...
	public Instrumentation.ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token,
			Activity target, Intent intent, int requestCode, Bundle options, UserHandle user) {
	...
	public void execStartActivities(Context who, IBinder contextThread, IBinder token, Activity target, Intent[] intents) {
		...
		RefInvoker.invokeMethod(instance, android.app.Instrumentation.class.getName(), Method_execStartActivities,
				new Class[] { Context.class, IBinder.class, IBinder.class, Activity.class, Intent[].class },
	...
	// ///// For Android 5.1
	public Instrumentation.ActivityResult execStartActivityAsCaller(Context who, IBinder contextThread, IBinder token,
			Activity target, Intent intent, int requestCode, Bundle options, int userId) {

		Object result = RefInvoker.invokeMethod(instance, android.app.Instrumentation.class.getName(),
				Method_execStartActivityAsCaller, new Class[] { Context.class, IBinder.class, IBinder.class,
						Activity.class, Intent.class, int.class, Bundle.class, int.class }, new Object[] { who,
	...
	public void execStartActivityFromAppTask(Context who, IBinder contextThread, Object appTask, Intent intent,
		...
		try {
			RefInvoker.invokeMethod(instance, Instrumentation.class.getName(), Method_execStartActivityFromAppTask,
