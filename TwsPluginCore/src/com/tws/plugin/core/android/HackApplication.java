...
public class HackApplication {
	...
	public void dispatchActivityCreated(Activity activity, Bundle savedInstanceState) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityCreated, new Class[] { Activity.class,
				Bundle.class }, new Object[] { activity, savedInstanceState });
	}

	public void dispatchActivityStarted(Activity activity) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityStarted, new Class[] { Activity.class },
				new Object[] { activity });
	}

	public void dispatchActivityResumed(Activity activity) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityResumed, new Class[] { Activity.class },
				new Object[] { activity });
	}

	public void dispatchActivityPaused(Activity activity) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityPaused, new Class[] { Activity.class },
				new Object[] { activity });
	}

	public void dispatchActivityStopped(Activity activity) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityStopped, new Class[] { Activity.class },
				new Object[] { activity });
	}

	public void dispatchActivitySaveInstanceState(Activity activity, Bundle outState) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivitySaveInstanceState, new Class[] {
				Activity.class, Bundle.class }, new Object[] { activity, outState });
	}

	public void dispatchActivityDestroyed(Activity activity) {
		RefInvoker.invokeMethod(instance, ClassName, Method_dispatchActivityDestroyed, new Class[] { Activity.class },
				new Object[] { activity });
	}
